...
export const HeroImg = () => {
    ...
    return (
        <>
            <Image alt='hero image one' src={HeroImgOne} className={`${styles.mySlides} ${styles.hero_img}`} width={768} height={124} />
            <Image alt='hero image two' src={HeroImgTwo} className={`${styles.mySlides} ${styles.hero_img}`} width={1600} height={900} />
            <Image alt='hero image three' src={HeroImgThree} className={`${styles.mySlides} ${styles.hero_img}`} width={2048} height={1536} />
        </>
    )
}
